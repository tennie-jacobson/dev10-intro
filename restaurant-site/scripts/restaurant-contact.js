function clearErrors() {
  for(var i = 0; i < document.forms["userInquiry"].elements.length; i++) {
    if(document.forms["userInquiry"].elements[i]
      ...
      document.forms["userInquiry"].elements[i].parentElement.className = "form-group form-inline";
    }
  }
}
...
function validateForm() {
  ...
  if(userName == isNaN(userName) || userName == "") {
    ...
    document.forms["userInquiry"]["userName"].parentElement.className = "form-group form-inline has-error";
    document.forms["userInquiry"]["userName"].focus();
    return false;
  }
  if(userEmail == isNaN(userEmail) || userEmail == "") {
    alert("Email is a required field.");
    document.forms["userInquiry"]["userEmail"].parentElement.className = "form-group form-inline has-error";
    document.forms["userInquiry"]["userEmail"].focus();
    return false;
  }
  if(userPhone == isNaN(userPhone) || userPhone == "") {
    alert("Phone number is a required field.");
    document.forms["userInquiry"]["userPhone"].parentElement.className = "form-group form-inline has-error";
